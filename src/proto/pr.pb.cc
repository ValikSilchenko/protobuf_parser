...
const uint32_t TableStruct_pr_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_pr_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_pr_2eproto_getter() {
  return &descriptor_table_pr_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_pr_2eproto(&descriptor_table_pr_2eproto);
namespace TestTask {
namespace Messages {
