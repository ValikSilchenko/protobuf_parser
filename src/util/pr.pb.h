...
#ifndef GOOGLE_PROTOBUF_INCLUDED_pr_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_pr_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_pr_2eproto
...
struct TableStruct_pr_2eproto {
    static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_pr_2eproto;
namespace TestTask {
    namespace Messages {
        class FastResponse;
...
template<>
::TestTask::Messages::FastResponse *Arena::CreateMaybeMessage<::TestTask::Messages::FastResponse>(Arena *);

template<>
::TestTask::Messages::RequestForFastResponse *
Arena::CreateMaybeMessage<::TestTask::Messages::RequestForFastResponse>(Arena *);

template<>
::TestTask::Messages::RequestForSlowResponse *
Arena::CreateMaybeMessage<::TestTask::Messages::RequestForSlowResponse>(Arena *);

template<>
::TestTask::Messages::SlowResponse *Arena::CreateMaybeMessage<::TestTask::Messages::SlowResponse>(Arena *);

template<>
::TestTask::Messages::WrapperMessage *Arena::CreateMaybeMessage<::TestTask::Messages::WrapperMessage>(Arena *);
...
// ===================================================================
        ...
        public:
            ...
            void set_allocated_request_for_fast_response(
        ...
        public:
            ...
            void set_allocated_request_for_slow_response(
        ...
        private:
            ...
            friend struct ::TableStruct_pr_2eproto;
        };
// -------------------------------------------------------------------
...
// optional .TestTask.Messages.RequestForFastResponse request_for_fast_response = 3;
        ...
        inline const ::TestTask::Messages::RequestForFastResponse &
        WrapperMessage::_internal_request_for_fast_response() const {
        ...
        inline ::TestTask::Messages::RequestForFastResponse *
        WrapperMessage::unsafe_arena_release_request_for_fast_response() {
        ...
        inline ::TestTask::Messages::RequestForFastResponse *
        WrapperMessage::_internal_mutable_request_for_fast_response() {
            _impl_._has_bits_[0] |= 0x00000004u;
        ...
        inline void WrapperMessage::set_allocated_request_for_fast_response(
                ::TestTask::Messages::RequestForFastResponse *request_for_fast_response) {
            ::PROTOBUF_NAMESPACE_ID::Arena *message_arena = GetArenaForAllocation();
            if (message_arena == nullptr) {
...
// optional .TestTask.Messages.RequestForSlowResponse request_for_slow_response = 4;
        ...
        inline const ::TestTask::Messages::RequestForSlowResponse &
        WrapperMessage::_internal_request_for_slow_response() const {
        ...
        inline ::TestTask::Messages::RequestForSlowResponse *
        WrapperMessage::unsafe_arena_release_request_for_slow_response() {
        ...
        inline ::TestTask::Messages::RequestForSlowResponse *
        WrapperMessage::_internal_mutable_request_for_slow_response() {
            _impl_._has_bits_[0] |= 0x00000008u;
        ...
        inline void WrapperMessage::set_allocated_request_for_slow_response(
                ::TestTask::Messages::RequestForSlowResponse *request_for_slow_response) {
            ::PROTOBUF_NAMESPACE_ID::Arena *message_arena = GetArenaForAllocation();
            if (message_arena == nullptr) {
...
// required string current_date_time = 1;
        ...
        void FastResponse::set_current_date_time(ArgT0 &&arg0, ArgT... args) {
            _impl_._has_bits_[0] |= 0x00000001u;
            _impl_.current_date_time_.Set(static_cast<const char *>(static_cast<ArgT0 &&>(arg0)), args..., GetArenaForAllocation());
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_pr_2eproto
